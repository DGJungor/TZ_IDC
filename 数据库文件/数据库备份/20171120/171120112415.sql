...
-- ----------------------------
--  Table structure for `idckx_admin_menu`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_admin_menu`;
CREATE TABLE `idckx_admin_menu` (
...
-- ----------------------------
--  Table structure for `idckx_asset`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_asset`;
CREATE TABLE `idckx_asset` (
...
-- ----------------------------
--  Table structure for `idckx_auth_access`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_auth_access`;
CREATE TABLE `idckx_auth_access` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8 COMMENT='权限授权表';

-- ----------------------------
--  Table structure for `idckx_auth_rule`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_auth_rule`;
CREATE TABLE `idckx_auth_rule` (
...
-- ----------------------------
--  Table structure for `idckx_comment`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_comment`;
CREATE TABLE `idckx_comment` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_hook`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_hook`;
CREATE TABLE `idckx_hook` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_hook_plugin`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_hook_plugin`;
CREATE TABLE `idckx_hook_plugin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
-- ----------------------------
--  Table structure for `idckx_link`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_link`;
CREATE TABLE `idckx_link` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_nav`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_nav`;
CREATE TABLE `idckx_nav` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_nav_menu`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_nav_menu`;
CREATE TABLE `idckx_nav_menu` (
...
-- ----------------------------
--  Table structure for `idckx_option`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_option`;
CREATE TABLE `idckx_option` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_plugin`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_plugin`;
CREATE TABLE `idckx_plugin` (
...
-- ----------------------------
--  Table structure for `idckx_portal_category`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_portal_category`;
CREATE TABLE `idckx_portal_category` (
...
-- ----------------------------
--  Table structure for `idckx_portal_category_post`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_portal_category_post`;
CREATE TABLE `idckx_portal_category_post` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_portal_tag`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_portal_tag`;
CREATE TABLE `idckx_portal_tag` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布,0:不发布',
  `recommended` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否推荐;1:推荐;0:不推荐',
...
-- ----------------------------
--  Table structure for `idckx_portal_tag_post`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_portal_tag_post`;
CREATE TABLE `idckx_portal_tag_post` (
...
-- ----------------------------
--  Table structure for `idckx_recycle_bin`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_recycle_bin`;
CREATE TABLE `idckx_recycle_bin` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_role`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_role`;
CREATE TABLE `idckx_role` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_role_user`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_role_user`;
CREATE TABLE `idckx_role_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_route`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_route`;
CREATE TABLE `idckx_route` (
...
-- ----------------------------
--  Table structure for `idckx_slide`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_slide`;
CREATE TABLE `idckx_slide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_slide_item`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_slide_item`;
CREATE TABLE `idckx_slide_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_theme`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_theme`;
CREATE TABLE `idckx_theme` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_theme_file`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_theme_file`;
CREATE TABLE `idckx_theme_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_third_party_user`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_third_party_user`;
CREATE TABLE `idckx_third_party_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user`;
CREATE TABLE `idckx_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user_action`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_action`;
CREATE TABLE `idckx_user_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user_action_log`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_action_log`;
CREATE TABLE `idckx_user_action_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
-- ----------------------------
--  Table structure for `idckx_user_favorite`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_favorite`;
CREATE TABLE `idckx_user_favorite` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user_login_attempt`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_login_attempt`;
CREATE TABLE `idckx_user_login_attempt` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user_score_log`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_score_log`;
CREATE TABLE `idckx_user_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_user_token`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_user_token`;
CREATE TABLE `idckx_user_token` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `idckx_verification_code`
-- ----------------------------
DROP TABLE IF EXISTS `idckx_verification_code`;
CREATE TABLE `idckx_verification_code` (
