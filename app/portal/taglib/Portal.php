...
class Portal extends TagLib
{
    ...
    protected $tags = [
        ...
        'articles'         => ['attr' => 'field,where,limit,order,page,relation,returnVarName,pageVarName,categoryIds,key', 'close' => 1],//非必须属性item
...
\${$pageVarName} = isset(\${$returnVarName}['page'])?\${$returnVarName}['page']:'';
 ...
 ?>
<volist name="{$returnVarName}.articles" key="{$key}" id="{$item}">
{$content}
</volist>
parse;
        return $parse;
