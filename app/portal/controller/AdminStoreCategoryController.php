<?php
    ...
    class AdminStoreCategoryController extends AdminBaseController
    {
         /**
         * 信息发布分类列表
         * @adminMenu(
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = InfoCategoryModel::get($id)->toArray();
...
tpl;
    ...
    {
        parent::listOrders(Db::name('info_category'));
        $this->success("排序更新成功！", '');
    }
    /**
     * 删除文章分类
...
//判断此分类有无子分类（不算被删除的子分类）
        ...
        $categoryPostCount = Db::name('info_category_post')->where('category_id', $id)->count();
