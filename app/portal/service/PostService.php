...

{
...

    {
        ...
        return $this->adminProductPostList($filter);

    }

    public function adminProductPageList($filter) 

    {

        return $this->adminProductPostList($filter,true);
    ...
    public function adminProductPostList($filter, $isPage = false)

    {
        ...
        $typelist = Db::name("info_category_post")->alias('cp')->join("idckx_info_category c","cp.category_id = c.id")->select();

        return ["data"=>$articles,"type"=>$typelist];
